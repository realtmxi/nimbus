"""Unit tests for router/run_queued.py. No network: the local sender is injected.

Run from the repo root:  python3 -m unittest router.test_run_queued -v
"""
...
from router.run import Endpoint, Policy
from router.run_queued import (
    LocalAdmission,
    parse_args,
    queue_stats,
    replay_queued,
